...
namespace DataLayer
{
    ...
    public class GameContext : IDb<Game, int>
    {
        ...
        public void Create(Game item)
        {
            ...
            List<Gamegenre> genres = new List<Gamegenre>(item.Genres.Count);
            foreach (Gamegenre genre in item.Genres)
            {
                Gamegenre genreFromDb = dbContext.Genres.Find(genre.GenreId);
